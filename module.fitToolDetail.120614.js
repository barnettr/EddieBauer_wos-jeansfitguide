    ...
    var methods = {
        init: function (options) {
            return this.each(function () {
                ...
                var $nav_on = $(".dashboard #button-front, .dashboard2 #button-front2, .dashboard3 #button-front3, .dashboard4 #button-front4, .dashboard5 #button-front5, .dashboard6 #button-front6");
        ...
        front: function (options) {
            return $(this).each(function (event) {
                ...
                var stopDoubleClick = $("div.dashboard" + $thisNumber + " div#button-" + $thisId + "");
                if (!stopDoubleClick.hasClass('nav_on')) {
                    var $nav_off = $(".dashboard" + $thisNumber + " #button-side" + $thisNumber + ", .dashboard" + $thisNumber + " #button-back" + $thisNumber + ", .dashboard" + $thisNumber + " #button-front" + $thisNumber + "");
                    $nav_off.removeClass('nav_on');
                    var $nav_on = $(".dashboard" + $thisNumber + " #button-" + $thisId + "");
                    $nav_on.addClass('nav_on');
        ...
        arrow: function (options) {
            return $(this).each(function (event) {
                ...
                var $nav_off = $(".dashboard" + $thisNumber + " #button-side" + $thisNumber + ", .dashboard" + $thisNumber + " #button-back" + $thisNumber + ", .dashboard" + $thisNumber + " #button-front" + $thisNumber + "");
                $nav_off.removeClass('nav_on');
                var $nav_on = $(".dashboard" + $thisNumber + " #button-" + $next.attr('id') + "");
                $nav_on.addClass('nav_on');
